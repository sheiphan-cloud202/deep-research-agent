...
from deep_research_agent.common.schemas import MissionBrief, AgentType, UseCases
...
class OrchestratorAgent:
    def __init__(self, workflow: Optional[list] = None):
    ...
    def run_workflow_from_conversation(self, conversation_history: list):
        ...
        final_report = self.workflow_context.get('final_report', "Workflow finished, but no final report was generated.")
        logger.info("\n--- END OF WORKFLOW ---")
    ...
    async def run_research_agents_parallel(self, mission_brief: MissionBrief):
        ...
        processed_results, agent_names = [], ["Generic Search", "Business Analysis", "Domain Search", "Trend Spotter", "User Persona"]
